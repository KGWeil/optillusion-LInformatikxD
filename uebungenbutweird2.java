...
public class uebungenbutweird2 extends PApplet
{   int black=0;
    int white=255;
    /**
     * settings() Methode 
    ...
    public void innereQuadrate(int x, int y, int farbe, boolean links)
    {
        ...
        for (int j=0; j<24; j++){
            for (int i=0; i<24; i++){
                square(25+i*40, 25+j*40, 10); 
                square(55+i*40, 55+j*40, 10);
    ...
    public static void main(String _args[]){ 
        PApplet.main(new String[] {uebungenbutweird2.class.getName() });
    }
